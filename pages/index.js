    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <section className="min-h-screen">
        ...
        <div className="text-center p-10"> 
          ...
          <p className="text-md py-5 leading-8 text-gray-800 md:text-xl lg:text-2xl max-w-xl mx-auto dark:text-slate-100">I am a developer that works with web and blckchain technology. 
      ...
      <section className="pt-4">
        <div className="text-center">
          ...
          <p className="text-md py-5 leading-8 text-gray-800 dark:text-slate-100">
            Since i started my development journey i have worked with a few project
          ...
          <p className="text-md py-5 leading-8 text-gray-800 dark:text-slate-100">
            I offer a wide range of service from web development to NFT development(full project), Dapp creation and much more skill set
          </p>
        </div>
        <div className="md:flex gap-10">
          <div className="shadow-lg text-center rounded-xl p-10 my-10 dark:bg-slate-100">
             ...
             <h3 className="text-lg font-medium pt-8 pb-2">SmarContract development</h3>
